...
CREATE TABLE "admin"(
  ...
  "nombrenucleo" VARCHAR(100),
  "entidadfederal" VARCHAR(100),
...
CREATE TABLE "profesor_has_catedra"(
  "profesor_idprofesor" INTEGER NOT NULL CHECK("profesor_idprofesor">=0),
  "catedra_idcatedra" INTEGER NOT NULL CHECK("catedra_idcatedra">=0),
  CONSTRAINT "fk_profesor_has_catedra_profesor1"
    FOREIGN KEY("profesor_idprofesor")
    REFERENCES "profesor"("idprofesor")
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT "fk_profesor_has_catedra_catedra1"
    FOREIGN KEY("catedra_idcatedra")
    REFERENCES "catedra"("idcatedra")
    ON DELETE CASCADE
    ON UPDATE CASCADE
